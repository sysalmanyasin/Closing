...
Object.assign(window, {
  ...
  onResponsibleStaffChange: Actions.onResponsibleStaffChange,
  ...
  btQaInit:             Pages.btQaInit,
  btQaSectionChange:    Pages.btQaSectionChange,
  btQaSubmit:           Pages.btQaSubmit,
  goToDashboard:        Pages.goToDashboard,
  goToSettings:         Pages.goToSettings,
  goToStaffLedger:      Pages.goToStaffLedger,
  slSwitchGrouping:     Pages.slSwitchGrouping,
  slClearFilters:       Pages.slClearFilters,
  slShowMore:           Pages.slShowMore,
  renderStaffLedger:    Pages.renderStaffLedger,
